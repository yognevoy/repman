...
use Buddy\Repman\MessageHandler\Organization\UnarchivePackageHandler;
...
final class UnarchivePackageHandlerTest extends TestCase
{
    /**
    ...
    private UnarchivePackageHandler $handler;
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new UnarchivePackageHandler($this->organizationRepository, $this->packageRepository);
    }
    ...
    public function testUnarchivePackage(): void
    {
        ...
        $package = new Package(Uuid::fromString($packageId), 'vcs', 'http://urlo');
        $package->archive();
        ...
        $message = new UnarchivePackage($packageId, $organizationId);
        ($this->handler)($message);

        self::assertFalse($package->isArchived());
    }
}
